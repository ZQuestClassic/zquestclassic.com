// Tokenizes syntaxes/zscript-grammar-test.zs with the vendored grammar and
// checks each `//! valid` / `//! invalid` marker against what the real
// TextMate engine produces. Run with: npm run check-zscript-grammar
import fs from 'fs';
